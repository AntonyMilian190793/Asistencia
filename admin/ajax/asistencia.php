	...
	case 'listar':
		...
		while ($reg=$rspta->fetch_object()) {
			$data[]=array(
				...
				"4"=>$reg->fecha,
				"5"=>$reg->hora,
				"6"=>($reg->tipo == "Entrada")?'<span class="label bg-primary">Entrada</span>' : '<span class="label bg-orange">Salida</span>',
				"7"=>($reg->estado == "Tardanza")?'<span class="label bg-red">Tardanza</span>':'<span class="label bg-blank">Normal</span>'
				);
		}
